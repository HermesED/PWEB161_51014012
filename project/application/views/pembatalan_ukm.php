      ...
      <div class="container">
        ...
        <div id="navbar" class="navbar-collapse collapse">
          ...
          <ul class="nav navbar-nav navbar-right">
            <li class="active2"><a href="http://kharisma.ac.id/" target="_blank">Pembatalan UKM<span class="sr-only">(current)</span></a></li>
          </ul>
          <ul class="nav navbar-nav navbar-right">
            <li class="aktif">
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-12 text-center">
                    <h2>FORM PEMBATALAN<br>ANGGOTA UKM</h2>
            ...
            <div class="row">
                <div class="col-lg-8 col-lg-offset-2">
                    ...
                    <form name="sentMessage" id="contactForm" novalidate>
                        ...
                        <div class="row control-group">
                            <div class="form-group col-xs-12 floating-label-form-group controls">
                                <label>Mengapa Anda Ingin Meninggalkan UKM Ini?</label>
                                <textarea rows="5" class="form-control" placeholder="Alasan" id="message" required data-validation-required-message="Tolong Masukkan Alasan Anda."></textarea>
                                <p class="help-block text-danger"></p>
                            </div>
                        </div>
                        <div class="row control-group">
                            <div class="form-group col-xs-12 floating-label-form-group controls">
                                ...
                                <textarea rows="5" class="form-control" placeholder="Pesan & Saran" id="message" required data-validation-required-message="Tolong Masukkan Pesan & Saran Anda."></textarea>
                                <p class="help-block text-danger"></p>
                            </div>
                        </div>
                        <br>
